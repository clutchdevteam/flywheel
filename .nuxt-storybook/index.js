...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"clutch-site","htmlAttrs":{"lang":"en"},"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""},{"name":"format-detection","content":"telephone=no"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_d9c03634 === 'function') {
    await nuxt_plugin_plugin_d9c03634(app.context, inject)
  }

  if (typeof nuxt_plugin_templatesplugin305eeb81_b574ecae === 'function') {
    await nuxt_plugin_templatesplugin305eeb81_b574ecae(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_0275b8fc === 'function') {
    await nuxt_plugin_axios_0275b8fc(app.context, inject)
  }
